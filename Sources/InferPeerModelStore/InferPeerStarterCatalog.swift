...
public enum InferPeerStarterCatalog {
    ...
    public static let signingKeyID = "inferpeer-starter-2026-09-v4"
...
private extension InferPeerStarterCatalog {
    ...
    static let publicKeyBase64 = "Mnx6zqYF2vxCktTYkZGeEyMCYARm+JfvRy5Ux7AnZwE="
    static let signatureBase64 =
        "GHggZmAD1i29fnaKlMrJo4uBg11q0gNdl/4irDsXTGREWvghw2IUeZNXunkFctVcENeFyS286IvITmmUA/WODQ=="
...
extension InferPeerStarterCatalog {
    static func unsignedCatalog() throws -> ModelCatalog {
        try ModelCatalog(
            revision: "starter-2026-09-19.4",
            generatedAt: Date(timeIntervalSince1970: 1_789_776_000),
            entries: [mlxEntry(), llamaEntry(), whisperEntry()]
        )
    }
}
...
private extension InferPeerStarterCatalog {
    ...
    static func mlxDeclarations() throws -> [Declaration] {
        let base = "https://huggingface.co/mlx-community/Qwen3-0.6B-4bit/resolve/"
            + mlxRevision
        let values: [(String, ModelManifestFileRole, UInt64, String)] = [
            ("added_tokens.json", .otherData, 707, "c0284b582e14987fbd3d5a2cb2bd139084371ed9acbae488829a1c900833c680"),
            ("config.json", .runtimeConfiguration, 937, "15d3ac26c043ae477273ed5802ee0f0b33bb14f18c9d3dd70910c02d906e3f1f"),
            ("merges.txt", .otherData, 1_671_853, "8831e4f1a044471340f7c0a83d7bd71306a5b867e95fd870f74d0c5308a904d5"),
            ("model.safetensors", .weights, 335_450_584, "392e8d466d56100ada00eb82031fb854297fc9e389b7d303eba3af114e87bce2"),
            ("model.safetensors.index.json", .otherData, 49_731, "7b294141456f6904936db03c00bca50fb5f6198f652fe8483f9cd2a1018accfb"),
            ("special_tokens_map.json", .otherData, 613, "76862e765266b85aa9459767e33cbaf13970f327a0e88d1c65846c2ddd3a1ecd"),
            ("tokenizer.json", .tokenizer, 11_422_654, "aeb13307a71acd8fe81861d94ad54ab689df773318809eed3cbe794b4492dae4"),
            ("tokenizer_config.json", .chatTemplate, 9_706, "253153d0738ceb4c668d2eff957714dd2bea0b56de772a9fdccd96cbf517e6a0"),
            ("vocab.json", .otherData, 2_776_833, "ca10d7e9fb3ed18575dd1e277a2579c16d108e32f27439684afa0e10b1440910"),
        ]
    ...
    static func llamaDeclarations() throws -> [Declaration] {
        ...
        let source = "https://huggingface.co/Qwen/Qwen3-0.6B-GGUF/resolve/"
    ...
    static func whisperCoreMLDeclarations() throws -> [Declaration] {
        let values: [(String, ModelManifestFileRole, UInt64, String)] = [
            ("AudioEncoder.mlmodelc/analytics/coremldata.bin", .otherData, 243, "c4e096b2abd561f00b9b698401df3fbe1a0d0c8d2476ff19cb4e1995680e827e"),
            ("AudioEncoder.mlmodelc/coremldata.bin", .otherData, 347, "e316980638e2099e83cb1a93b903717dc12b3c2168d0ab69113764c3767696ba"),
            ("AudioEncoder.mlmodelc/metadata.json", .otherData, 1_863, "d6785fae31c3f86d60058c14c79902f716f106dd9e36af7d3fe78b9c34867fce"),
            ("AudioEncoder.mlmodelc/model.mil", .otherData, 579_125, "dc74813e26fce790fe22a33dcef8be535b9dce566f38a8bdb677f5e07dcf9138"),
            ("AudioEncoder.mlmodelc/model.mlmodel", .otherData, 79_853, "1d42038f84b508da5ce9b953302387ffedc097c346d36a56b765109002b6080e"),
            ("AudioEncoder.mlmodelc/weights/weight.bin", .weights, 41_189_632, "061ff4d74e5de3937b31288465d6c6f2697f92d121c80b23f51dd26bbdfe642b"),
            ("MelSpectrogram.mlmodelc/analytics/coremldata.bin", .otherData, 243, "7f77e6457285248f99cd7aa3fd4cc2efbb17733e63e7023ac53abe1f95785d07"),
            ("MelSpectrogram.mlmodelc/coremldata.bin", .otherData, 328, "dabdc5aa69f6ef4d97dc9499f5c30514e00e96b53b750b33a5a6471363c71662"),
            ("MelSpectrogram.mlmodelc/metadata.json", .otherData, 1_848, "f2b08d80d9cdd39fc0ccdbb5fac86a5f8dd9bcaa839706c3568be6fe8abd82d4"),
            ("MelSpectrogram.mlmodelc/model.mil", .otherData, 10_176, "b8063d8e57c113472ac7c2d248e44383568a018978a753c1884ac406b997a374"),
            ("MelSpectrogram.mlmodelc/weights/weight.bin", .audioModel, 354_080, "35d74417ef9c765e70f4ef85fe7405015a7086e9af05e3b63a5c2c7c748b2efc"),
            ("TextDecoder.mlmodelc/analytics/coremldata.bin", .otherData, 243, "6ac1227740ecc2fd7a03df50ac6e2a7f7946acfa77069cf2c486ae0255356b95"),
            ("TextDecoder.mlmodelc/coremldata.bin", .otherData, 633, "9f1f6fe409486e2797d3f0c65d9a6d5af596771760548cd86f41939c54cdbe7c"),
            ("TextDecoder.mlmodelc/metadata.json", .otherData, 4_753, "0a64b3686b9a4b2eff0792e7df3cfe1b20467ec5d5ac52c0e01c3dbf6697b65d"),
            ("TextDecoder.mlmodelc/model.mil", .otherData, 205_217, "45b9e61a0f286cddcad96e2c890c7a68460adcaa3319c4907ee4f962dfeb2c8b"),
            ("TextDecoder.mlmodelc/model.mlmodel", .otherData, 164_481, "ae260ff7b95d0c957c3c1f4df4dbeaa0ae6c76bacc55eb86caca8f6820d346f0"),
            ("TextDecoder.mlmodelc/weights/weight.bin", .otherData, 104_122_162, "72325d42a4a4ccc8a6fa974ede6cdf2e0770685a5c4f9da94f41495b94d8d174"),
            ("config.json", .runtimeConfiguration, 1_464, "67e25477d03bf3a1c34bfd137724beed94b5218d0457e8c1d25f70379a61d9d5"),
            ("generation_config.json", .otherData, 2_762, "662a99e3db3067708549d04d5f141910eb455f0935aed0c9b06d707f44bfbcaf"),
        ]
        let base = "https://huggingface.co/argmaxinc/whisperkit-coreml/resolve/"
            + whisperRevision + "/openai_whisper-base/"
        return try values.map { value in
            try declaration(
                path: value.0,
    ...
    static func whisperTokenizerDeclarations() throws -> [Declaration] {
        ...
        let base = "https://huggingface.co/openai/whisper-base/resolve/"
